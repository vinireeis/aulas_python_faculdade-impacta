...
'''
A proxima funcao recebe somente o dicionario dos dados do brasileirao ela retorna a id do time que foi campeao.
'''
...
def nome_campeao(dados):
    # campeaoid = dados['fases']['2700']['classificacao']['grupo']['Único'][0]
    # return nome = ['equipes']
...
'''
A proxima função recebe (alem do dicionario de dados do brasileirao) uma id de
time
...
class TestClientes(unittest.TestCase):
    ...
    #  vou falsificar os dados pra testar se vc esta lendo direito da estrutura
        dados['fases']['2700']['faixas-classificacao']['classifica1']
        ['faixa'] = '1-8'
